...
{
    public class CqsFileStorage : ICqsStorage
    {
        private readonly SemaphoreSlim _commandLock = new SemaphoreSlim(1);
        private readonly string _dataDirectory;
        private readonly SemaphoreSlim _eventLock = new SemaphoreSlim(1);
        private readonly SemaphoreSlim _queryLock = new SemaphoreSlim(1);
        private readonly SemaphoreSlim _requestLock = new SemaphoreSlim(1);
        private readonly JsonSerializerSettings _settings;

        public CqsFileStorage(string dataDirectory)
        {
        ...
        public CqsFileStorage(Environment.SpecialFolder rootFolder, string applicationName)
        {
            _settings = new JsonSerializerSettings()
            {
                ConstructorHandling = ConstructorHandling.AllowNonPublicDefaultConstructor,
